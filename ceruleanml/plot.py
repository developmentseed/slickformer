...
def plot_instance_masks(
    ...
    mask_arrs: list,
    mask_cat_ids: dict,
    class_list: list = utils.class_list,
    ...
    Args:
        ...
        class_list (list): The list of category keys that map to utils.class_dict.
    ...
    """
    new_class_dict = remap_class_dict(utils.class_dict, class_list)
    ...
    for i, mask in enumerate(mask_arrs):
        ...
        for contour in rounded_contours:
            ...
            try:
                ...
                TypeError
            ):  # coord less than 2 issue TODO figure out why this happens with thresholding sometimes. poly too small?
                raise TypeError("huh")
